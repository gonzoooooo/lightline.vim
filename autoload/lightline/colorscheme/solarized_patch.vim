" =============================================================================
" Filename: autoload/lightline/colorscheme/solarized_patch.vim
" Author: gonzoooooo
" License: MIT License
" Last Change: 2020/01/01 15:13:00.
" =============================================================================
...
let s:base03 = [ '#586e75', s:cuicolors.base03[s:cuiindex] ]
...
let s:p.normal.left = [ [ s:base02, s:blue ], [ s:base02, s:base00 ] ]
let s:p.normal.right = [ [ s:base02, s:base1 ], [ s:base02, s:base00 ] ]
let s:p.inactive.right = [ [ s:base02, s:base00 ], [ s:base0, s:base02 ] ]
let s:p.inactive.left =  [ [ s:base0, s:base02 ], [ s:base0, s:base02 ] ]
let s:p.insert.left = [ [ s:base02, s:green ], [ s:base02, s:base00 ] ]
let s:p.replace.left = [ [ s:base02, s:red ], [ s:base02, s:base00 ] ]
let s:p.visual.left = [ [ s:base02, s:magenta ], [ s:base02, s:base00 ] ]
...
let g:lightline#colorscheme#solarized_patch#palette = lightline#colorscheme#flatten(s:p)
